...
| File | Purpose |
|------|---------|
| `planning/PLAN.md` | Full project specification (included below) |
...
At the end of every working session, ask the user: "Should we update `current_state.md`?" before closing.
